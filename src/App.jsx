...
function App() {
  ...
  const passwordGenerator = useCallback(() => {
    let pass = "";
    let str = "ABCDEFGHIJKLMNOPKURSTUVWXYZabcde3fghijklmnopqrstuvwxyz";
    ...
    setPasword(pass);
  }, [length, numberAllowed, charAllowed, setAllowed,setPasword]); //fn,[]

  const copyPasswordToClipboard = useCallback(()=>{
    passwordRef.current?.select();
    passwordRef.current?.setSelectionRange(0,130);
